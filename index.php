  ...
  <div class="container">
    <div class="row fullscreen align-items-center justify-content-between">
      <div class="col-lg-6 col-md-6 banner-left">
        ...
        <h1 class="text-white">Kuningan</h1>
        <p class="text-white">
          Sistem informasi ini merupakan aplikasi pemetaan geografis tempat wisata di wilayah Kuningan. Aplikasi ini memuat informasi dan lokasi dari tempat wisata di Kuningan.
        </p>
    ...
    <section id="peta_wisata" class="about-info-area section-gap">
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD1_wkpCuvAF427CVfFrHv1lWH2HVU3LFc&callback=initMap "></script>
          ...
          <script type="text/javascript">
            function initialize() {
              ...
              var mapOptions = {
                zoom: 10.2,
                center: new google.maps.LatLng(-6.905066579979626, 108.41612974875342),
      ...
      <div class="row d-flex justify-content-center">
        <div class="menu-content pb-70 col-lg-8">
          <div class="title text-center">
            ...
            <p>Aplikasi pemetaan geografis Wisata di Kota Kuningan ini memuat informasi dan lokasi dari Wisata ALam dan WIsata Kuliner di Kuningan. Pemetaan diambil dari data lokasi Google Maps dan data dari website masing-masing tempat wisata.
            </p>
          </div>
        </div>
      </div>
